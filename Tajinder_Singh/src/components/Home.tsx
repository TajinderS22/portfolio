...
const Home = () => {
  return (
    <div className='max-w-[1920px] w-full mx-auto transform transition-all duration-500 '>
      ...
      <div id='About' className='text-white w-10/12 mx-auto p-6 my-14'>
        <div className='flex justify-between'>
          <div className='flex-1 mt-8 pr-6'>
          ...
          <div>
            <img 
            className="w-120 transform drop-shadow-[0_10px_15px_rgba(81,207,179,0.4)]  hover:scale-110 transition-all hover:[transform:rotateY(10deg)] duration-500 ease-in-out rounded-lg" 
