  ...
  return (
    <div className=" transform md:w-11/12  z-20 items-center justify-center md:gap-6 gap-40 md:pl-6 mx-auto flex flex-col  ">
      ...
      <GithubProjectCard
        Name={"Netflix-GPT"}
        ImageUrl={
          "https://res.cloudinary.com/dcpz5001o/image/upload/v1759581932/Screenshot_from_2025-10-04_18-13-26_ttscvf.png"
        }
        GithubUrl={"https://github.com/TajinderS22/netflix-gpt/"}
        description={
          "Netflix GPT uses advanced AI to recommend movies based on user prompts, delivering personalized suggestions that match your unique preferences. With a sleek Netflix-like interface, it’s designed to help you discover the perfect movie or show quickly, making every viewing experience just right."
        }
        TechStack={[
          "React.js",
          "MongoDB",
