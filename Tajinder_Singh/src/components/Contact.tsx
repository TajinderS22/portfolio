...
const Contact = () => {
  return (
    ...
    >
      {/* Heading */}
      <h2 className="text-4xl md:text-5xl font-bold mb-6 dark:text-green-200 text-green-600  z-10 ">Contact Me</h2>
      <p className="text-green-800 dark:text-green-300 mb-10 z-10 text-center max-w-2xl">
        Interested in working together or just want to say hi?  
        Feel free to reach out using the details below or connect through social links.
      </p>

      {/* Contact Cards */}
      <div className="grid md:grid-cols-2 gap-8 w-full z-10 max-w-3xl">
        {/* Email */}
        <div className="flex items-center gap-4 bg-green-300/60 dark:bg-green-600/30 mx-auto not-md:max-w-[320px]  w-full max-w-[500px]  p-5 rounded-2xl border border-zinc-800 hover:border-green-400 transition">
          <Mail className="text-green-600 dark:text-green-300  h-8" />
          <div>
        ...
        <div className="flex items-center gap-4 bg-green-300/60 dark:bg-green-600/30 mx-auto not-md:max-w-[315px]  w-full max-w-[500px]  p-5 rounded-2xl border border-zinc-800 hover:border-green-400 transition">
          <MapPin className="text-green-600 dark:text-green-300 w-8 h-8" />
          <div>
        ...
        {/* LinkedIn */}
        <div className="flex items-center gap-4 bg-green-300/60 dark:bg-green-600/30 mx-auto not-md:max-w-[315px]  w-full max-w-[500px]  p-5 rounded-2xl border border-zinc-800 hover:border-green-400 transition">
          <Linkedin className="text-green-600 dark:text-green-300 w-8 h-8" />
          <div>
        ...
        {/* GitHub */}
        <div className="flex items-center gap-4 bg-green-300/60 dark:bg-green-600/30 mx-auto not-md:max-w-[315px]  w-full max-w-[500px]  p-5 rounded-2xl border border-zinc-800 hover:border-green-400 transition">
          <Github className="text-green-600 dark:text-green-300 w-8 h-8" />
          <div>
